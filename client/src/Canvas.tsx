...
import ReactFlow, { Background, Controls, addEdge, type Connection, type Edge, type Node, MiniMap } from "reactflow";
import "reactflow/dist/style.css";
import { fetchDefaultWorkflow, saveWorkflow } from "./api";
...
export default function Canvas() {
  ...
  useEffect(() => {
    (async () => {
      const wf = await fetchDefaultWorkflow();
      setWorkflowId(wf.id);
      setName(wf.name);
